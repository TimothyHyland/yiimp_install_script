...
################################################################################
   ...
   php_version='8.2'
    ...
    cd ~
    hide_output git clone https://github.com/TimothyHyland/yiimp.git
    ...
    define('"'"'YAAMP_BTCADDRESS'"'"', '"'"'16uNjqH5yqY4JaMTHtzddAHP2PfXYTGjhV'"'"');
	...
	'"'"'16uNjqH5yqY4JaMTHtzddAHP2PfXYTGjhV'"'"' => 0.10,
    );
